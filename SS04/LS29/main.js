function PostItem(props) {
    return (
        <div className>
            ...
            />
            <h2 className="post-item">{props.title}</h2>
...
function App() {
    return (
        <div className="wrapper">
            <PostItem
                urlImage="https://fullstack.edu.vn/static/media/f8-icon.18cd71cfcfa33566a22b.png"
                titleImage="F8"
                title="Học lập trình"
                description="Học lập trình để đi làm"
                published="1 năm trước"
            />
            ...
            <PostItem
                ...
                titleImage="F8"
                title="MyCV"
                description="Viết CV để đi làm"
                published="2 năm trước"
            />
        </div>
    );
}
...
const courses = [
    {
        ...
        "is_registered": true,
        "user_progress": 100,
        "last_completed_at": "2022-07-27 07:02:18",
...

    {
        ...
        "is_registered": true,
        "user_progress": 100,
        "last_completed_at": "2022-08-23 01:18:29",
...

    {
        ...
        "is_registered": true,
        "user_progress": 100,
        "last_completed_at": "2022-07-27 06:59:49",
...

    {
        ...
        "is_registered": true,
        "user_progress": 100,
        "last_completed_at": "2022-08-31 01:27:01",
...

    {
        ...
        "is_registered": true,
        "user_progress": 100,
        "last_completed_at": "2022-09-15 14:03:19",
...

    {
        ...
        "is_registered": true,
        "user_progress": 11,
        "last_completed_at": "2022-09-16 01:44:25",
...

    {
        ...
        "is_registered": true,
        "user_progress": 24,
        "last_completed_at": "2022-09-21 03:12:06",
...
function CourseItem(props) {
    return (
        <div className="course-item">
            ...
            <p className="members">Student: {props.studentsCount}</p>
        </div>
    );
};
